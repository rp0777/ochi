function Footer() {
  return (
    <div
      ...
      data-scroll-section
      data-scroll-speed="-.1"
      className=" flex flex-col lg:flex-row lg:gap-5 w-full h-screen px-[8vw] lg:px-20 py-24"
    >
      <div className=" w-full lg:w-1/2 lg:h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className=" text-[10vw] lg:text-[6vw] font-medium uppercase leading-none tracking-tighter lg:-mb-5">
            Eye-
          </h1>

          <h1 className=" text-[10vw] lg:text-[6vw] font-medium uppercase leading-none tracking-tighter lg:-mb-10">
            Opening
          </h1>
        </div>
      ...
      <div className=" w-full lg:w-1/2 lg:h-full flex flex-col justify-start items-start gap-10">
        <h1 className=" text-[10vw] lg:text-[6vw] font-medium uppercase leading-none tracking-tighter">
          Presentations
        </h1>
        ...
        <div className=" flex flex-col justify-center items-start gap-10">
          ...
          <div className=" flex flex-col justify-center items-start gap-5">
            ...
            <p className=" hover:underline">Vancouver, Canada</p>

            <p className=" hover:underline">Lviv, Ukraine</p>
          </div>
        </div>
      </div>
    </div>
